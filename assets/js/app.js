...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).foundation(); // init controller
...
new ScrollMagic.Scene({
  triggerElement: "#hero-mission"
}).setTween("#hero-mission > div", {
  y: "80%",
  ease: Linear.easeNone
}).addTo(controller);
new ScrollMagic.Scene({
  triggerElement: "#hero-project-kasilof"
}).setTween("#hero-project-kasilof > div", {
  y: "80%",
  ease: Linear.easeNone
}).addTo(controller);
new ScrollMagic.Scene({
  triggerElement: "#hero-30bga"
}).setTween("#hero-30bga > div", {
  y: "80%",
  ease: Linear.easeNone
}).addTo(controller);
new ScrollMagic.Scene({
...
module.exports = __webpack_require__(/*! /Users/bdixon/SITES/grizzlyguidingwisdom/src/assets/js/app.js */"./src/assets/js/app.js");
